...
dict = {'A': 1,'E': 1, 'I': 1,'O': 1,'U': 1,'L': 1,'N': 1,'S': 1,'T': 1,'R': 1, 'А': 1,'В': 1,'Е': 1,'И': 1,'Н': 1,'О': 1,'Р': 1,'С': 1,'Т': 1,
...
for i in range(len(strUp)):
  result = result + dict[strUp[i]]
  
print("Ценность строки: ", result, "символов")  
